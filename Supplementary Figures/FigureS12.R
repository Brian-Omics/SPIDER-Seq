...
ggsave("../pdf/FigureS12/p1.pdf", plot = p, height = 12, width = 6, units = "in")



load("../data/csv/CAMs_AGMs/CAMs_AGMs.hdwgcna.RData")

p2 <- PlotDendrogram(seu.hdwgcna.AGMs_CAMs, main='hdWGCNA Dendrogram')
...
p3 <- plot_grid(plotlist = plist, ncol=5)

ggsave("../pdf/FigureS12/p3.pdf", plot = p3, height = 3, width = 15, units = "in")



ModuleNetworkPlot(
  seu.hdwgcna.AGMs_CAMs,
  outdir = '../pdf/FigureS12/ModuleNetworks'
)
