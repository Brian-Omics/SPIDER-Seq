...
ggsave("../pdf/FigureS1/p1.pdf", plot = p1, height = 6, width = 8, units = "in")
...
ggsave("../pdf/FigureS1/p2.pdf", plot = p2, height = 4, width = 6, units = "in")
...
ggsave("../pdf/FigureS1/p3.pdf", plot = p3, height = 4, width = 6, units = "in")
...
p <- plot_grid(p1,p2,p3,ncol=3,rel_widths=c(1,0.75,0.75))

ggsave("../pdf/FigureS1/p4.pdf", plot = p, height = 4, width = 8, units = "in")
...
ggsave("../pdf/FigureS1/p5.pdf", plot = p5, height = 4, width = 5, units = "in")
...
ggsave("../pdf/FigureS1/p6.pdf", plot = p6, height = 6, width = 10, units = "in")
...
ggsave("../pdf/FigureS1/p7.pdf", plot = p7, height = 6, width = 15, units = "in")
...
p8 <- plot_grid(plotlist = plist, ncol = 8)
ggsave("../pdf/FigureS1/p8.pdf", plot = p8, height = 6, width = 24, units = "in")
...
ggsave("../pdf/FigureS1/p9.pdf", plot = p9, height = 4, width = 4, units = "in")
...
ggsave("../pdf/FigureS1/p10.pdf", plot = p10, height = 4, width = 4, units = "in")
...
ggsave("../pdf/FigureS1/p11.pdf", plot = p11, height = 4, width = 4, units = "in")
...
ggsave("../pdf/FigureS1/p12.pdf", plot = p12, height = 4, width = 4, units = "in")
