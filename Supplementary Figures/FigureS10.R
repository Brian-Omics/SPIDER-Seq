...
ggsave("../pdf/FigureS10/p1.pdf", plot = p1, height = 3, width = 4, units = "in")
...
ggsave("../pdf/FigureS10/p2_1.pdf", plot = p2_1, height = 3, width = 6, units = "in")
...
ggsave("../pdf/FigureS10/p2_2.pdf", plot = p2_2, height = 3, width = 6, units = "in")
