...
ggsave("../pdf/Figure4/p1.pdf", plot = p, height = 7, width = 14, units = "in")
...
rgl.snapshot('../pdf/Figure4/p2_1.png', top = TRUE)
...
ggsave("../pdf/Figure4/p2_2.pdf", plot = p2_2, height = 5, width = 2, units = "in")
...
ggsave("../pdf/Figure4/p2_3.pdf", plot = p2_3, height = 5, width = 2, units = "in")
...
ggsave("../pdf/Figure4/p3.pdf", plot = p3, height = 4, width = 6, units = "in")
...
ggsave("../pdf/Figure4/p4.pdf", plot = p4, height = 4, width = 4, units = "in")
...
pdf(file="../pdf/Figure4/p5.pdf", width=4, height=4)
circos.clear()
circos.par(gap.after = c(rep(5,4), 20, rep(5,4), 20))
chordDiagram(
  df[order(link$type),], order = area_order, grid.col = grid.col, col = col[order(link$type)], transparency = 0,
...
ggsave("../pdf/Figure4/p6.pdf", plot = p6, height = 4, width = 4, units = "in")
...
ggsave("../pdf/Figure4/p7.pdf", plot = p7, height = 4.5, width = 4, units = "in")
