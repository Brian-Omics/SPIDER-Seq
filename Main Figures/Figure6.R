...
ggsave("../pdf/Figure6/p1.pdf", plot = p1, height = 4, width = 10, units = "in")
...
proj_module <- c("PTi","ITi-M1","ITi-M2")
plist <- list()
for (i in 1:3){
...
p2 <- plot_grid(plotlist = plist, ncol = 3)

ggsave("../pdf/Figure6/p2.pdf", plot = p2, height = 3, width = 8, units = "in")
...
p3 <- plot_grid(plotlist = plist, nrow = 1)

ggsave("../pdf/Figure6/p3.pdf", plot = p3, height = 3, width = 9, units = "in")
...
gene_BC_mat <- cbind(
  gene_BC_mat,
  seu@meta.data[,c('PTi_score','ITi_M1_score','ITi_M2_score')]
)
colnames(gene_BC_mat)[4:6] <- c('PTi', 'ITi-M1', 'ITi-M2')

Gene_module <- c('module 1','module 2','module 3')
Proj_module <- c('PTi', 'ITi-M1', 'ITi-M2')
plist <- list()
for (i in 1:3){
  df_i <- gene_BC_mat[,c(Gene_module[i],'PTi', 'ITi-M1', 'ITi-M2')]
  df_i <- df_i[df_i[,1]>0,]
...
p4 <- plot_grid(plotlist = plist, nrow = 1)

ggsave("../pdf/Figure6/p4.pdf", plot = p4, height = 3, width = 8, units = "in")
...
ggsave("../pdf/Figure6/p6.pdf", plot = p6, height = 4, width = 8, units = "in")
...
ggsave("../pdf/Figure6/p7_1.pdf", plot = p7_1, height = 3, width = 6, units = "in")
...
ggsave("../pdf/Figure6/p7_2.pdf", plot = p7_2, height = 3, width = 6, units = "in")
...
ggsave("../pdf/Figure6/p7_3.pdf", plot = p7_3, height = 4, width = 4, units = "in")
...
ggsave("../pdf/Figure6/p8_1.pdf", plot = p8_1, height = 3, width = 6, units = "in")
...
ggsave("../pdf/Figure6/p8_2.pdf", plot = p8_2, height = 3, width = 6, units = "in")
...
ggsave("../pdf/Figure6/p8_3.pdf", plot = p8_3, height = 4, width = 4, units = "in")
